...
<div class="page-content">
					...
					<div class="row align-items-center">
						<div class="col-lg-9 col-xl-10  d-flex justify-content-lg-start justify-content-center">
							<div class="page-breadcrumb d-flex d-sm-flex align-items-center mb-2">
								<div class="breadcrumb-title pe-3">Our Clients</div>
								<div class="ps-3">
	...
	{{-- <h6 class="mb-0 text-uppercase">Our Clients</h6>
	<hr/> --}}
					...
					<li class="align-items-center {{ $loop->last ? '' : 'border-bottom pb-2' }}">
						<div class="row g-0">
							<div class="d-flex align-items-center my-3">
								<h5 class="mb-1">Clients {{ $loop->iteration }}</h5>
								<div class="dropdown ms-auto">
									<a href="{{ route('our-clients.edit', $row->id) }}" class="btn btn-sm btn-outline-secondary">Edit</a>
								</div>
							</div>
							<div class="col-md-12">
								<div class="">
