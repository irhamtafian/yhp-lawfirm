								...
								<div class="ps-3">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb mb-0 p-0">
											...
											<li class="breadcrumb-item" aria-current="page"><a href="/admin/about-us">About Us</a></li>
		...
		<div class="card-body">
			<form action="{{ route('about-us.update', $aboutUs->id) }}" method="POST" enctype="multipart/form-data">
					...
					<li class="align-items-center">
						<div class="row g-0">
							<div class="d-flex align-items-center my-3">
								<h5 class="mb-1">Edit About Us {{ $aboutUs->id }}</h5>
							</div>
						</div>
					</li>
							...
							<div class="col-md-2">
								<div style="padding-right: 16px">
									<div class="mb-3">
										...
										@if ($aboutUs->image)
											<img src="{{ asset('storage/' . $aboutUs->image) }}" class="img-fluid border mt-3" width="100%" height="200" alt="...">
										@endif
							...
							<div class="col-md-10">
								<div class="">
									...
									<div class="mb-3">
										...
										<textarea class="form-control" id="description" name="description" rows="4">{{ $aboutUs->description }}</textarea>
				...
				<div class="d-flex justify-content-end mt-3">
					<a href="/admin/about-us" class="btn btn-secondary me-2" onclick="window.history.back();">Cancel</a>
