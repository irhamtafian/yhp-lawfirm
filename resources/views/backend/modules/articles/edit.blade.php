					...
					<div class="row align-items-center">
						<div class="col-lg-9 col-xl-10  d-flex justify-content-lg-start justify-content-center">
							<div class="page-breadcrumb d-flex d-sm-flex align-items-center mb-2">
								<div class="breadcrumb-title pe-3">Edit Articles</div>
								<div class="ps-3">
		...
		<div class="col-xl-12 mx-auto">
			<div class="card">
				<div class="card-body p-4">
					...
					<form class="row g-3" action="{{ route('articles.update', $article->id) }}" method="post" enctype="multipart/form-data">
						@csrf
						@method('PUT')
						<div class="col-md-6">
						...
						<div class="col-md-3">
							...
							<img src="{{ asset('storage/'.$article->header_articles) }}" class="img-fluid" alt="{{ $article->title }}" style="margin-top: 10px;">
						...
						<div class="col-md-12">
							...
							<textarea class="form-control" name="content" id="content" placeholder="Enter Description" rows="10">{{ $article->content }}</textarea>
